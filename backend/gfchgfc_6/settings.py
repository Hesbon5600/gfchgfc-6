"""
Django settings for gfchgfc_6 project.
...
WSGI_APPLICATION = 'gfchgfc_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gfchgfc_6 API",
    "DESCRIPTION": "API documentation for gfchgfc_6 App",
    "VERSION": "v1",
}
